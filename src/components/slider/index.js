...
export default function Slider() {
    ...
    return (
        <>
            ...
            >
                {content.map( offer =>(
                    <SwiperSlide key={offer.id} style={{background: `url('${offer.image}')no-repeat center`, backgroundSize: 'cover'}}>
                        ...
                        <div className={styles.wrapper}>
                            ...
                            <div className={styles.block2}>
                                ...
                                <div className={styles.buy}>
                                    <a href={`${offer.buy}`} target={"_blank"}>КУПИТЬ БИЛЕТ</a>
                                </div>
                            </div>
                        </div>
                        <div className={styles.startCalendar} style={{background: `url('${offer.image}')no-repeat center `,backgroundSize: 'cover'}}>
